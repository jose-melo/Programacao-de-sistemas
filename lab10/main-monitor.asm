...
;
				-  EX                ;
                JZ OPEX              ; Teste se o comando é um EX
;
                JP ERROCMD           ; Se não for nem LO nem DU, então é um erro de comando
;
OPEX            SC TRATAOPEX         ; Realiza a operação de executar
                JP LOOP              ;
;
OPLOAD          SC TRATALOAD         ;
				SC PEGADADO
...
TRATAOPEX       K  /0000
                ...
                JZ ERROCMD          ; Se não pular linha deu erro no comando			
                ...
                LD GET              ; Carrega D000
                +  LOADER_UL        ; Soma com a unidade lógica do arquivo
                +  DISCO            ; Soma com 0300
                MM INST1            ; Escreve na instrução abaixo
INST1           K  /0000            ; Lê o endereço de execução
                MM END_EXE          ; Grava no endereço de execução
                /  MIL              ; Divide por 1000
                *  MIL              ; Multiplica por 1000
                JZ CERTOEX          ; É um endereço válido do tipo 0xxx
                JP ERROEX           ; Deu erro: end. inválido
CERTOEX         LV END_EX           ; Joga para o acumulador o end de execução
                OS /0EF             ; Chamada de supervisor
                JP LOOP             ; Retorna para o loop do MBS                
;====================================
;Função TRATADUMP
;====================================
TRATADUMP       K  /0000
